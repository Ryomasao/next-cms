...
SSGをベースに考えたほうがわかりやすい。  

- publishedなコンテンツであれば、ただの静的ページになってるのでパフォーマンスが非常に高い
- 新しいコンテンツの場合、ビルドしなおす or SSR && CSRの組み合わせ or ISR

## SSG

### メリット

- フロントエンドをフロントエンドのエコシステムで開発することができ、開発体験が非常に高い
- ただの静的ページなのでパフォーマンスがいい
